...
class QuizzesController extends Controller
{
    ...
    {
        $quizzes = Quiz::with(['schedule', 'creator'])
    ...
    public function create()
    {
        ...
        return view('admin.quizzes.form', compact('sessions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.quizzes.index')->with('message', 'Quiz created successfully.');
    }
    ...
    public function edit(Quiz $quiz)
    {
        ...
        $sessions = Schedule::orderBy('day_number')->orderBy('start_time')->get();
        return view('admin.quizzes.form', compact('quiz', 'sessions'));
    }
    ...
    public function update(Request $request, Quiz $quiz)
    {
        ...
        return redirect()->route('admin.quizzes.index')->with('message', 'Quiz updated successfully.');
    }

    public function destroy(Quiz $quiz)
    {
        $quiz->delete();
        return redirect()->route('admin.quizzes.index')->with('message', 'Quiz deleted.');
    }
