...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div style="display:flex; gap:8px;">
        <a href="{{ route('facilitator.messages.compose', ['to' => $message->sender_id]) }}" class="btn btn-sm" style="background:#C9A84C; color:#fff; font-size:12px; font-weight:700;">
            <i class="fas fa-reply mr-1"></i> Reply
        </a>
        <a href="{{ route('facilitator.messages.index') }}" class="btn btn-sm" style="background:#f8f9fa; color:#555; border:1px solid #dee2e6; font-size:12px;">
...
<div class="card shadow-sm" style="border-radius:8px; max-width:760px;">
    ...
    <div class="card-footer" style="background:#f8f9fa; border-top:1px solid #e9ecef; text-align:right;">
        <form action="{{ route('facilitator.messages.destroy', $message) }}" method="POST" style="display:inline;"
