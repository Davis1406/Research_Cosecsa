...
<div class="row mb-2">
    <div class="col-lg-12 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.directory.index') }}" class="btn btn-sm" style="background:#f8f9fa; color:#555; border:1px solid #dee2e6; font-size:13px;">
    ...
    <div class="col-md-4 mb-3">
        <div class="card shadow-sm" style="border-radius:10px; overflow:hidden;">
            <div style="background:linear-gradient(135deg, #2d3748 0%, #1a202c 100%); padding:28px; text-align:center;">
                ...
                <span style="display:inline-block; margin-top:8px; font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.8px; padding:2px 12px; border-radius:20px; background:#C9A84C33; color:#C9A84C; border:1px solid #C9A84C55;">
                    {{ $roleTitle }}
                </span>
            </div>
            <div class="card-body">
                ...
                <div style="margin-bottom:12px;">
                    ...
                    @if(!$speaker->twitter && !$speaker->linkedin && !$speaker->researchgate && !$speaker->google_scholar && !$speaker->orcid && !$speaker->web_of_science)
