...
<div class="chat-wrap" style="height:calc(100vh - 200px);">
    ...
    <div class="chat-header">
        ...
        <a href="{{ route('admin.directory.index') }}" style="font-size:12px; color:#a0aec0; text-decoration:none;" title="Directory">
...
@section('scripts')
<script>
const SEND_URL   = "{{ route('admin.messages.send', $user) }}";
const POLL_URL   = "{{ route('admin.messages.poll', $user) }}";
