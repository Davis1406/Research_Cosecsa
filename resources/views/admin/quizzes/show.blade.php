...
<div class="row mb-2">
    <div class="col-lg-12 d-flex justify-content-between align-items-center">
        ...
        <div style="display:flex; gap:8px;">
            <a href="{{ route('admin.quizzes.edit', $quiz) }}" class="btn btn-sm" style="background:#C9A84C; color:#fff; font-size:12px; font-weight:700;">
                <i class="fas fa-edit mr-1"></i> Edit
            </a>
            <a href="{{ route('admin.quizzes.index') }}" class="btn btn-sm" style="background:#f8f9fa; color:#555; border:1px solid #dee2e6; font-size:12px;">
        ...
        <div class="card shadow-sm" style="border-radius:8px; border-left:4px solid #C9A84C;">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 mb-2">
                        <div style="font-size:10px; font-weight:700; text-transform:uppercase; color:#aaa; letter-spacing:0.5px;">Created By</div>
                        <div style="font-size:13px; color:#2d3748;">{{ $quiz->creator?->name ?? '—' }}</div>
                    </div>
                </div>
                @if($quiz->description)
...
<div class="card shadow-sm" style="border-radius:8px;">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover datatable datatable-Attempts mb-0">
            <thead>
                <tr>
                    <th>User</th>
                    <th>Score</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:12px; color:#888;">{{ $attempt->completed_at ? $attempt->completed_at->format('M j, Y g:i A') : '—' }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
