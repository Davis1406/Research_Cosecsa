...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand">
            ...
            <ul class="navbar-nav d-none d-sm-flex ml-3">
                <li class="nav-item">
                    <span class="nav-link d-flex align-items-center" style="color:rgba(255,255,255,0.85); font-size:13px; gap:8px;">
                        <img src="{{ asset('img/cosecsa-favicon.png') }}" alt="" style="width:22px; height:22px; border-radius:50%; border:1px solid #C9A84C;">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span style="color:rgba(255,255,255,0.9)">{{ auth()->user()->name ?? 'Admin' }}</span>
                    </a>
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b>COSECSA</b> &mdash; College of Surgeons of East, Central and Southern Africa
            </div>
            <strong>&copy; {{ date('Y') }}</strong> COSECSA Research Training System Platform. All rights reserved.
        </footer>
